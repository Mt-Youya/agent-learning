...
export type ImageGenerationProps = React.PropsWithChildren
...
export function ImageGeneration({ children }: ImageGenerationProps) {
  ...
  return (
    <div className="flex flex-col gap-2">
      <motion.span
        className="bg-[linear-gradient(110deg,var(--color-muted-foreground),35%,var(--color-foreground),50%,var(--color-muted-foreground),75%,var(--color-muted-foreground))] bg-size-[200%_100%] bg-clip-text text-transparent font-medium"
